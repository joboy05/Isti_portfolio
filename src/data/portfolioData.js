...
export const services = [
  {
    ...
    description: "Stratégie, planning éditorial, community management et analyse de performances.",
    icon: "MdOutlineHub"
  },
  {
    id: 2,
    title: "Création de Contenu",
    description: "Shooting, montage vidéo (Reels/TikTok), copywriting et scénarisation.",
    icon: "MdOutlineAutoAwesome"
  },
  {
    id: 3,
    title: "Design Graphique",
    description: "Logos, chartes graphiques, miniatures YouTube et supports de communication.",
...
export const testimonials = [
  {
    ...
    name: "Thomas Durand",
    role: "CEO, Coffee Co.",
    content: "Le travail sur notre identité visuelle a dépassé nos espérances. Un vrai talent créatif !",
    avatar: "https://i.pravatar.cc/150?u=thomas"
  },
  {
    id: 2,
    name: "Sophie Martin",
    role: "Responsable Marketing, TechFlow",
    content: "Une gestion de réseaux sociaux irréprochable. Notre engagement a explosé en 3 mois.",
